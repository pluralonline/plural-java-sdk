                ...
                <div class="py-5 text-center">
                    ...
                    <div class="text-center"> 
                        ...
                        <div class="col-md-12 text-center">
                            ...
                            <span>|</span>
                            <a href="http://localhost:8081/emiCalculator" id="emiLink" target="_blank">EMI Order Details</a>
                            <span>|</span>
                            <a href="http://localhost:8081/hashVerificationView2" target="_blank">Hash Verification</a>
                        </div>  
                    </div>
                </div> 
                    ...
                    <div class="col-md-6 col-lg-12">
                        <form method="post" action="submit"class="needs-validation">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-3">
                                    <label for="product_code1" class="form-label">Product Code</label>
                                    <input type="text" name="product_code1" class="form-control" id="product_code1" placeholder="Product Code" value="testSKU1" >
                                </div>
    
                                <div class="col-sm-3">
                                    <label for="product_amount1" class="form-label">Product Amount</label>
                                    <input type="text" name="product_amount1" class="form-control" id="product_amount1" placeholder="Product Amount" value="2000000" >
                                </div>

                                <div class="col-sm-3">
                                    <label for="product_code2" class="form-label">Product Code</label>
                                    <input type="text" name="product_code2" class="form-control" id="product_code2" placeholder="Product Code" value="testSKU2" >
                                </div>
    
                                <div class="col-sm-3">
                                    <label for="product_amount2" class="form-label">Product Amount</label>
                                    <input type="text" name="product_amount2" class="form-control" id="product_amount2" placeholder="Product Amount" value="2000000">
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <li><input type="checkbox" name="payment_mode1" id="card" value="card" checked><label for="card" style="margin-left: 5px;">Credit Debit Card</label></li>
                                            ...
                                            <li><input type="checkbox" name="payment_mode2" id="wallet" value="wallet" checked><label for="wallet" style="margin-left: 5px;">Wallet</label></li>
                                            <li><input type="checkbox" name="payment_mode3" id="upi" value="upi" checked><label for="upi" style="margin-left: 5px;">UPI</label></li>
                                            <li><input type="checkbox" name="payment_mode4" id="emi" value="emi"><label for="emi" style="margin-left: 5px;">EMI</label></li>
                                            <li><input type="checkbox" name="payment_mode5" id="debit_emi" value="debit_emi"><label for="debit_emi" style="margin-left: 5px;">Debit Card EMI</label></li>
                                            <li><input type="checkbox" name="payment_mode6" id="cardless_emi" value="cardless_emi"><label for="cardless_emi" style="margin-left: 5px;">Cardless EMI</label></li>
                                            <li><input type="checkbox" name="payment_mode7" id="bnpl" value="bnpl"><label for="bnpl" style="margin-left: 5px;">BNPL</label></li>
                                            <li><input type="checkbox" name="payment_mode8" id="prebooking" value="prebooking"><label for="prebooking" style="margin-left: 5px;">Pay Later</label></li>
                                        </ul>
                                    </div>
                                </div>
